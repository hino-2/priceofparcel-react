...
import { layoutMobile, layoutDesktop, showECOM, hideECOM, getEcomPvzFromFile, addPlacemark,  removePlacemark } from './actions'
  ...
  return (
    <div className="app">
      <div className="left-panel">
        ...
        {/* <button onClick={() => dispatch(getEcomPvzFromFile())}>get ecom from file</button> */}
        <button onClick={() => dispatch(addPlacemark(placemark))}>add placemark</button>
        <button onClick={() => dispatch(removePlacemark(placemark))}>remove placemark</button>
      </div>
      <div className="map">
        <YMap />
      </div>
